...
# Script para conectar servicios a PostgreSQL usando Cloud SQL Auth Proxy
# Soluciona el problema de conectividad entre Cloud Run y Cloud SQL
...
print_info "🔗 Conectando servicios a PostgreSQL con Cloud SQL Auth Proxy"
print_info "============================================================="
...
# Función para deployar servicio con Cloud SQL Auth Proxy
...
# Deployar servicios con Cloud SQL Auth Proxy
...
print_success "✅ Conexión con Cloud SQL Auth Proxy completada"
print_info "💡 Los servicios ahora usan PostgreSQL con conexión segura"
